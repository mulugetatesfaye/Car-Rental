  ...
  return (
    <div className="hidden md:flex items-center justify-between px-8 py-4 border-b border-neutral-800 bg-neutral-900/50 backdrop-blur-sm sticky top-0 z-30">
      ...
      <div className="relative" ref={popupRef}>
        ...
        {/* Notification Popup */}
        {isOpen && (
          <div className="absolute right-0 top-full mt-2 w-[380px] bg-neutral-900 border border-neutral-800 shadow-2xl shadow-black/50 z-50 animate-in slide-in-from-top-2 fade-in duration-200">
            {/* Popup Header */}
...
function NotifItem({
  ...
  return (
    <div
      className={`flex items-start gap-3.5 px-5 py-4 border-b border-neutral-800/50 transition-all cursor-pointer hover:bg-neutral-800/30 ${
    ...
    >
      ...
      {/* Icon */}
      <div className="mt-0.5 flex-shrink-0 w-8 h-8 flex items-center justify-center bg-neutral-800/50 border border-neutral-700/50">
